                ...
                bossMessage.findOne({
                    ...
                    new bossMessage({
                        ...
                        let embed = new Discord.RichEmbed()
                            ...
                            .setColor(`#36393E`)const Discord = require("discord.js");
const mongoose = require("mongoose");
const fs = require("fs");
                ...
                bossMessage.findOne({
                    ...
                    new bossMessage({
                        ...
                        client.channels.get(config.bossVoteChannel).fetchMessage(config.bossVoteMessage).then(m => {
                            ...
                            client.channels.get(config.bossVoteChannel).overwritePermissions(newMember.guild.roles.find('name', '@everyone'), {
